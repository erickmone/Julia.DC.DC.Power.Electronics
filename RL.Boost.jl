...
f1=rlocusplot(Gvd,xlims=(-4e4,4e4),ylims=(-2.5e4,2.5e4),);
f2=rlocusplot(Gid,xlims=(-4e4,4e4),ylims=(-2.5e4,2.5e4),);
f3=bodeplot(LTISystem[Gvd], label=L"G_{vd}",c=:blue);
f4=bodeplot(LTISystem[Gid], label=L"G_{id}",c=:orange);